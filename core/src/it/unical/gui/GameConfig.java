...
public class GameConfig {
	...
	public static final String splashImage = "splashScreen.png";
	public static final String boxImage = "Crate_Yellow.png";
	public static final String boxColorImage = "boxColor.png";
	public static final String goalImage = "goal.png";
	public static final String grassImage = "grass.png";
	public static final String groundImage = "ground.png";
	public static final String playerImage = "George.png";
	public static final String skyImage = "sky.jpg";
	public static final String wallImage = "Wall_Brown.png";
	public static final String wall2Image = "wall2.png";
	public static final String wallBigImage = "wallBig.png";
